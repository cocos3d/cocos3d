...
1. The cocos3d framework is built on [cocos2d 1.x](http://www.cocos2d-iphone.org).
Before installing cocos3d, you must [download](http://www.cocos2d-iphone.org/download) and install the cocos2d 1.x.  
  
	** PLEASE NOTE THAT cocos3d IS NOT COMPATIBLE WITH cocos2d 2.x.
	BE SURE TO DOWNLOAD cocos2d 1.x FOR USE WITH cocos3d. **

2. Download the latest [cocos3d release](http://cocos3d.org),
...
cocos3d is compatible with all cocos2d 1.x versions.

** PLEASE NOTE THAT cocos3d IS NOT COMPATIBLE WITH cocos2d 2.x. **

At the time of this release, the current version of cocos2d is 1.1, and by default, cocos3d is
configured to use that version.
...
File->New->NewProject... menu selection, and select the 'cocos3d1 Application'
...
To learn more about cocos3d, please refer to the [cocos3d Programming Guide](http://brenwill.com/2011/cocos3d-programming-guide/) and the latest [API documentation](http://brenwill.com/docs/cocos3d/0.7.2/api/).
...
To convert COLLADA files to POD files, you can use the Collada2POD converter tool available
in the PowerVR SDK, which is available free from Imagination Technologies, the supplier of
the GPU's used in iOS devices.

Read the [full instructions](http://brenwill.com/2011/cocos3d-importing-converting-collada-to-pod/)
for more info on where to get the Collada2POD converter, and how to use it to convert
COLLADA files to POD files.
